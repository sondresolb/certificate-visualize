...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(self.score_treeView.sizePolicy().hasHeightForWidth())
        ...
        item = QtWidgets.QTableWidgetItem()
        self.connection_details.setItem(3, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.connection_details.setItem(4, 0, item)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cert_chain_treeView.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, Form):
        ...
        item.setToolTip(_translate("Form", "Transport Layer Security Versions supported by server"))
        item = self.connection_details.verticalHeaderItem(3)
        item.setText(_translate("Form", "Protocol"))
        item.setToolTip(_translate("Form", "Protocol used for securing certificate transfer"))
        item = self.connection_details.verticalHeaderItem(4)
        item.setText(_translate("Form", "Cipher suite"))
        item.setToolTip(_translate("Form", "Cipher suite used for securing certificate transfer"))
        ...
        item.setToolTip(_translate("Form", "DNS Certificate Autorithy Authorization"))
        item = self.connection_details.verticalHeaderItem(8)
        item.setText(_translate("Form", "Certificates"))
        item.setToolTip(_translate("Form", "Certificates served by the server"))
